...
public final class NeuronsConnection implements PooledConnection, Connection {
	...
	/**
	 * <h3 class="en-US">Constructor method for database connection implement class</h3>
	 * <h3 class="zh-CN">数据库连接实现类的构造方法</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Getter method for create time of current connection</h3>
	 * <h3 class="zh-CN">连接建立的时间的Getter方法</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Getter method for last activated time of current connection</h3>
	 * <h3 class="zh-CN">最后一次使用连接的时间的Getter方法</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Update last activated time of current connection</h3>
	 * <h3 class="zh-CN">更新当前连接的最后一次使用时间</h3>
	 */
	...
	/**
	 * <h3 class="en-US">Reset current connection</h3>
	 * <h3 class="zh-CN">重置当前连接</h3>
	 */
	...
	/**
	 * <h3 class="en-US">Generate statement instance object</h3>
	 * <h3 class="zh-CN">生成查询分析器实例对象</h3>
	 *
	...
	private <T> T createStatement(final KeyType keyType, final String sql,
		...
		if (cachedStatement == null) {
			switch (keyType) {
				case CALL_ONLY:
					cachedStatement = new CachedCallableStatement(this, cacheKey,
				...
				case CALL_HOLDABILITY:
					...
					break;
				case SQL_ONLY:
					cachedStatement = new CachedPreparedStatement(this, cacheKey,
	...
	/**
	 * <h3 class="en-US">Generate identification code of statement instance</h3>
	 * <h3 class="zh-CN">生成查询分析器缓存唯一识别代码</h3>
	 *
	 * @param keyType              <span class="en-US">Enumeration value of SQL command type</span>
	 *                             <span class="zh-CN">SQL语句类型枚举值</span>
	 * @param sql                  <span class="en-US">SQL command</span>
