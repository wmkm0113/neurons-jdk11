...
public interface NeuronsDataSourceMBean {
	...
	/**
	 * <h3 class="en-US">Connections count in connection pool</h3>
	 * <h3 class="zh-CN">连接池中现有连接数</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Activated connections count</h3>
	...
	/**
	 * <h3 class="en-US">Waiting to get count of connections</h3>
	 * <h3 class="zh-CN">等待获取连接的计数</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Data source was closed</h3>
	 * <h3 class="zh-CN">数据源已经关闭</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Configure minimum connection limit of database connection pool</h3>
	 * <h3 class="zh-CN">设置数据库连接池最小连接数</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Configure maximum connection limit of database connection pool</h3>
	 * <h3 class="zh-CN">设置数据库连接池最大连接数</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Configure timeout value of database connection validate check</h3>
	...
	/**
	 * <h3 class="en-US">Configure timeout value of create database connection</h3>
	 * <h3 class="zh-CN">设置创建数据库连接的超时时间</h3>
	 *
	 * @param timeout <span class="en-US">Timeout value</span>
	 *                <span class="zh-CN">超时时间</span>
	 */
	...
	/**
	 * <h3 class="en-US">Configure cached limit value of statement</h3>
	 * <h3 class="zh-CN">设置缓存的查询分析器最大值</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Configure retry limit value of create connection if failed</h3>
	 * <h3 class="zh-CN">设置获取数据库连接的最大重试次数</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Configure username of database connection pool</h3>
	 * <h3 class="zh-CN">设置数据库连接用户名</h3>
	 *
	...
	/**
	 * <h3 class="en-US">Configure password of database connection pool</h3>
	 * <h3 class="zh-CN">设置数据库连接密码</h3>
	 *
